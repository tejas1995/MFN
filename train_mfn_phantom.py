...
def train_mfn_phantom(X_train, y_train, X_valid, y_valid, X_test, y_test, configs, mode):
...
while True:
	...
	#train_mfn_phantom(X_train, y_train, X_valid, y_valid, X_test, y_test, configs, mode)
